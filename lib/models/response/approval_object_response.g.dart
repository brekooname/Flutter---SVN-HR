...
ApprovalObjectResponse _$ApprovalObjectResponseFromJson(
  ...
  return ApprovalObjectResponse()
    ...
    ..vacationTransactionPeriod = json['vacationTransactionPeriod'] as num
    ...
    ..vacationHolidayDays = json['vacationHolidayDays'] as num
    ...
    ..leaveStartTime = json['leaveStartTime'] as num
    ..leaveEndTime = json['leaveEndTime'] as num
