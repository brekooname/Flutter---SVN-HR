...
part of 'get_approval_object_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetApprovalObjectResponse _$GetApprovalObjectResponseFromJson(
    Map<String, dynamic> json) {
  return GetApprovalObjectResponse()
    ...
    ..vacationTransactionPeriod = json['vacationTransactionPeriod'] as String
    ...
    ..vacationHolidayDays = json['vacationHolidayDays'] as String
    ..vacationPaidDays = json['vacationPaidDays'] as String
    ..vacationUnPaidDays = json['vacationUnPaidDays'] as String
    ..vacationPreviousBalance = json['vacationPreviousBalance'] as String
    ..vacationNewBalance = json['vacationNewBalance'] as String
    ...
    ..leaveStartTime = json['leaveStartTime'] as String
    ..leaveEndTime = json['leaveEndTime'] as String
    ...
    ..loanApprovedAmount = json['loanApprovedAmount'] as String
    ..loanPaymentDueDate = json['loanPaymentDueDate'] as String
    ..extraWorkUnit = json['extraWorkUnit'] as String
    ..extraWorkUnitQuantity = json['extraWorkUnitQuantity'] as String
    ...
    ..expenseApprovedAmount = json['expenseApprovedAmount'] as String
    ...
    ..empBenefitRequestAmt = json['empBenefitRequestAmt'] as String
    ..empBenefitRequestDate = json['empBenefitRequestDate'] as String
    ..empBenefitUnitPrice = json['empBenefitUnitPrice'] as String
    ..leaveEncashmentAmount = json['leaveEncashmentAmount'] as String
    ...
    ..salaryIncCurrentSalary = json['salaryIncCurrentSalary'] as String
    ..salaryIncApprovedAmount = json['salaryIncApprovedAmount'] as String
    ..salaryIncIncrType = json['salaryIncIncrType'] as String
    ..salaryIncRequestAmount = json['salaryIncRequestAmount'] as String
...
Map<String, dynamic> _$GetApprovalObjectResponseToJson(
        GetApprovalObjectResponse instance) =>
    <String, dynamic>{
