...
import '../Loans/LoanRequestScreen.dart';
...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void getProfileScreens() {
    for (ProfileScreenResponse screen in LoginController.listOfProfileScreens!) {
      ...
      // else if (screen.screenName.compareTo(LoanRequestScreen.id) == 0) {
      //   DrawerList item = DrawerList(
      //     index: DrawerIndex.LOANS,
      //     labelName:
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: ModernTheme.backgroundColor.withOpacity(0.1),
      ...
      body: Column(
        ...
        children: <Widget>[
         _buildHeader(),
          Divider(color: ModernTheme.accentColor.withOpacity(0.6), thickness: 1,),
  ...
  Widget inkwell(DrawerList listData) {
    Color highlightColor = ModernTheme.accentColor.withOpacity(0.1); // Lighter shade of blue for highlight
    Color selectedItemColor = ModernTheme.accentColor; // Accent color for selected item
    Color unselectedItemColor = ModernTheme.textColor.withOpacity(0.7); // Less intense color for unselected items
              ...
              child: Row(
                children: <Widget>[
                  Container(
                    ...
                    height: 46.0,
                    decoration: BoxDecoration(
                      color: widget.screenIndex == listData.index ? selectedItemColor : Colors.transparent,
                  ...
                  listData.isAssetsImage! ? Container(
                    width: 24,
                    height: 24,
                    child: Image.asset(
                      listData.imageName!,
                      color: widget.screenIndex == listData.index ? selectedItemColor : unselectedItemColor,
                    ),
                  ) : Icon(
                    listData.icon!.icon,
                    color: widget.screenIndex == listData.index ? selectedItemColor : unselectedItemColor,
